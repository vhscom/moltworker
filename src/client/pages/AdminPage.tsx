...
export default function AdminPage() {
	...
	const handleApproveAll = async () => {
		...
		try {
			...
			setError(
				err instanceof Error ? err.message : "Failed to approve devices",
			);
		} finally {
			setActionInProgress(null);
		}
	...
	const handleRestartGateway = async () => {
		...
		try {
			...
			if (result.success) {
				...
				alert(
					"Gateway restart initiated. Clients will reconnect automatically.",
				);
			} else {
		...
		try {
			...
			if (result.success) {
				...
				setStorageStatus((prev) =>
					prev ? { ...prev, lastSync: result.lastSync || null } : null,
				);
				setError(null);
			} else {
	...
	return (
		<div className="devices-page">
			...
			{storageStatus && !storageStatus.configured && (
				<div className="warning-banner">
					<div className="warning-content">
						...
						<p>
							Paired devices and conversations will be lost when the container
							restarts. To enable persistent storage, configure R2 credentials.
							See the{" "}
							<a
				...
				<div className="success-banner">
					<div className="storage-status">
						<div className="storage-info">
							<span>
								R2 storage is configured. Your data will persist across
								container restarts.
							</span>
			...
			<section className="devices-section gateway-section">
				...
				<p className="hint">
					Restart the gateway to apply configuration changes or recover from
					errors. All connected clients will be temporarily disconnected.
				</p>
			</section>
					...
					<section className="devices-section">
						...
						{pending.length === 0 ? (
							<div className="empty-state">
								...
								<p className="hint">
									Devices will appear here when they attempt to connect without
									being paired.
								</p>
							</div>
						) : (
									...
									<div key={device.requestId} className="device-card pending">
										...
										<div className="device-details">
											...
											<div className="detail-row">
												...
												<span
													className="value"
													title={formatTimestamp(device.ts)}
												>
									...
									>
										...
										<div className="device-details">
											...
											<div className="detail-row">
												...
												<span
													className="value"
													title={formatTimestamp(device.approvedAtMs)}
												>
